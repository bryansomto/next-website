  ...
  return (
    <aside
      className={
        ...
        " top-0 text-surfaceBright p-4 mr-0 fixed w-full bg-surfaceBG h-full sm:static sm:w-auto transition-all"
      }
    >
      ...
      <nav className="flex flex-col gap-2 w-full">
        ...
        <Link
          ...
          className={
            pathname.includes("/admin/blogPosts") ? activeLink : inactiveLink
          }
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            ...
            stroke="currentColor"
            className={
              pathname.includes("/admin/blogPosts") ? activeIcon : inactiveIcon
            }
          >
            <path
              strokeLinecap="round"
